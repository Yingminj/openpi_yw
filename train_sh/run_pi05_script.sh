...
EXPERIMENT_NAME="pi0.5fine_tuning_tidy_up_ad_prompt"
...
printf '[%s] Config=%s exp_name=%s dataset=%s global_batch=12 per_device_batch=4 steps=150000 keyframe_sampling=disabled prompt_from_task=true\n' \
